...
def add_new_traveller(data, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'add_traveller'):
...
def get_traveller_details(traveller_id, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'view_traveller_details'):
        print("Error: Permission denied.")
        return None
...
def update_traveller_details(traveller_obj, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'update_traveller'):
        print("Error: Permission denied.")
        return False
...
def delete_traveller_record(traveller_id, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'delete_traveller'):
        print("Error: Permission denied.")
        return False
...
def add_new_service_engineer(username, password, first_name, last_name, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'add_service_engineer'):
        print("Error: Permission denied.")
        return None
    try:
...
def add_new_system_admin(username, password, first_name, last_name, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'add_system_admin'):
...
def find_service_engineers(query, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'search_service_engineers'):
        print("Error: Permission denied.")
        return []
...
def update_own_profile(user_id, first_name, last_name, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'update_own_profile'):
        print("Error: Permission denied.")
        return False
...
def change_own_password(current_user, old_password, new_password):
    ...
    """
    if not authorization.has_permission(current_user.role, 'change_own_password'):
        print("Error: Permission denied.")
...
def update_service_engineer_profile(profile_obj, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'update_service_engineer_profile'):
        print("Error: Permission denied.")
        return False
...
def delete_service_engineer(user_id, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'delete_service_engineer'):
        print("Error: Permission denied.")
        return False
...
def reset_service_engineer_password(user_id, new_password, current_user):
    ...
    """
    if not authorization.has_permission(current_user.role, 'reset_service_engineer_password'):
        print("Error: Permission denied.")
        return False
...
def add_new_scooter(data, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'add_scooter'):
        print("Error: Permission denied.")
        return None
    try:
...
def search_scooters(query, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'search_scooters'):
        print("Error: Permission denied.")
        return []
...
def get_scooter_details(scooter_id, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'view_scooter_details'):
        print("Error: Permission denied.")
        return None
...
def update_scooter_details(scooter_obj, current_user, is_limited=False):
    ...
    if not authorization.has_permission(current_user.role, required_permission):
        print("Error: Permission denied.")
        return False
...
def delete_scooter_record(scooter_id, current_user):
    ...
    if not authorization.has_permission(current_user.role, 'delete_scooter'):
        print("Error: Permission denied.")
        return False
...
def view_system_logs(current_user):
    ...
    if not authorization.has_permission(current_user.role, 'view_system_logs'):
        print("Error: Permission denied.")
        return []
...
def create_backup(current_user):
    ...
    if not authorization.has_permission(current_user.role, 'create_backup'):
        print("Error: Permission denied.")
        return None
...
def list_backups(current_user):
    ...
    if not authorization.has_permission(current_user.role, 'restore_backup'):
        print("Error: Permission denied.")
        return []
